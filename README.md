...
- 原型说明：[docs/prototype.md](docs/prototype.md)
- API 契约：[packages/shared/api-contract.md](packages/shared/api-contract.md)
- 部署与中间件：[infra/docker-compose.yml](infra/docker-compose.yml)
- AI Worker 启动说明：[services/ai-worker/README.md](services/ai-worker/README.md)
- 项目 TODO：[../project-todo.md](../project-todo.md)
- 原始产品记录：[../ReadMe.md](../ReadMe.md)
...
诊断脚本会检查常用依赖版本、5173/8080/3306/6379/9000/9001 端口占用、`.env.local` 关键配置、Web 依赖和 Docker Compose 配置。启动失败时先运行该命令定位直接原因。
